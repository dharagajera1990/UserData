            ...
            {columns.map((column) => {
              ...
              return (
                 <th key={column.accessor}>
                  ...
                  {column.sort !== false && <button onClick={() => handleSort(column.accessor)}>{sortIcon()}</button>}
                </th>
              )
            })}
          </tr>
            ...
            return (
              <tr key={row.id}>
                {columns.map((column) => {
                  ...
                  if (column.img) {
                    return <td key={column.accessor}><img src={row[column.accessor]} /></td>
                  }
                  if (column.action === 'delete') {
                    return <td key={column.accessor}>
                            <a onClick={handleRemoveSpecificRow(row.id)}>Delete</a>
                          </td>
                  }
